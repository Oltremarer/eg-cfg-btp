...
"""
    ...
    def run_experiment(self, output_dir, collect_problems=5):
        ...
        with open(output_path / "btp_fast_results.json", 'w', encoding='utf-8') as f:
...
def main():
    parser = argparse.ArgumentParser(description="快速BTP实验")
    parser.add_argument("--model_name", type=str, 
                       default="HuggingFaceTB/SmolLM2-135M-Instruct",
                       help="模型名称（推荐SmolLM2-135M-Instruct）")
    parser.add_argument("--dataset", type=str, default="mbpp")
    parser.add_argument("--output_dir", type=str, default="experiments/results/btp_fast")
    ...
    experiment = BTPExperimentFast(args.model_name, args.dataset)
